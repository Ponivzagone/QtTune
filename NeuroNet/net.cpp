...
Net::Net(const std::vector<unsigned> &topology)
{
    ...
    trainingSet loadWeight("D:/ProgramsExample/Unversity4course/kursovaia/dataSetNet/InOutWeight.txt");
...
void Net::getneuroWeight()
{
    ...
    std::ofstream fout;
    fout.open("D:/ProgramsExample/Unversity4course/kursovaia/dataSetNet/InOutWeight.txt");
